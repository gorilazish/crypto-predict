...
numpy.savetxt(output_file, historical_prices, delimiter=',')
# numpy.savetxt('btc_ohlcv_' + str(timestamp_to_date(from_timestamp)) + ' - ' + str(timestamp_to_date(to_timestamp)) + '.csv', historical_prices, delimiter=',')
